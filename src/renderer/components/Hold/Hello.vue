<template>
  <div class="hello">
    <div class="container margin-top-20px">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3" v-for="person in people" :key="person.id">
          <b-card class="mb2">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <b-card class="mb2">
            ...
            <div slot="header">
              ...
              <span class="header" v-else>New Person</span>
            </div>
            ...
            <small slot="footer">
              ...
              <b-button class="btn" v-else @click="createPerson" variant="success">Create</b-button>
